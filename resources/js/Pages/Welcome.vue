                ...
                <main>
                    <div class="text-center max-w-5xl mx-auto">
                        ...
                        <div class="text-center mt-6 mb-6">
                            <div class="w-full flex items-center text-center justify-center">
                                <div class="w-1/2 text-center justify-center ml-14 mr-14">
                                    <h2 class="text-2xl font-bold mb-6">One Url & Multiple Links</h2>
                            ...
                            <div class="w-full mt-6 mb-6 flex items-center text-center justify-center">
                                ...
                                <div class="w-1/2 text-center justify-center ml-14 mr-14">
                                    ...
                                    <p>Log in via Instagram, add your links and retrieve your unique URL. It literally takes 1 minute to get started.</p>
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-16 mb-16">
                            ...
                            <div class="flex w-full mt-2 mb-10">
